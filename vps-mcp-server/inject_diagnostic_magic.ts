...
console.log("🔥 INJECTING DIAGNOSTIC MAGIC SEED ROUTE...");

const conn = new Client();
conn.on("ready", () => {

    // We update the magic seed route to be purely diagnostic first
...
// --- MAGIC DIAGNOSTIC ROUTE ---
api.get('/magic-seed', (req, res) => {
    try {
        const db = getDb();
        console.log('[MAGIC] Diagnostic...');
