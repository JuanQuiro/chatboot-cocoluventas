# -*- coding: utf-8 -*-
import sys
# Force update stdout to handle utf-8 even in restricted windows env
...
try:
    ...
    # Read output but handle decoding safely and don't print special chars if possible, 
    # but sys.stdout.reconfigure should fix it.
